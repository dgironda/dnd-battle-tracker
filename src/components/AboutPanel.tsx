...
export default function AboutPanel({ onClose }: AboutPanelProps) {
  return (
    <div id="about">
      <button id="aboutCloseButton" onClick={onClose}>
        X
      </button>
      <div id="instructions">
        <h3>Instructions</h3>
        <ul>
          <li>
            Toggle your D&D edition (5e 2014/2024) using the rules version button in Options.
          </li>
          <li className="indent">
            This affects concentration checks, condition definitions and which monsters you can add in the monster manager dropdown.
          </li>
          ...
          <br />
          <li>
            During battle Concentration and Death Saving Throw reminders will pop up if the correct status is marked.
          </li>
        ...
        <div>
          ...
          <p>
            <img src={KeyA} alt="A key" className="keyShortcut" /> - check/uncheck current player's Action
          </p>
          <p>
            <img src={KeyS} alt="S key" className="keyShortcut" /> - check/uncheck current player's Bonus
          </p>
          <p>
          ...
          <p>
            <img src={KeyX} alt="X key" className="keyShortcut" /> - close Combatant hover stat box
          </p>
        </div>
      </div>
      <div id="credits">
        ...
        <p>
          ...
          <a href="https://madmilliner.github.io/jasonPeterson/" target="_blank" rel="noreferrer">
            Jason Peterson
          </a>
        </p>
        <p>
          Art by{" "}
          <a href="https://bio.site/aetherillo" target="_blank" rel="noreferrer">
            Aether Ilo - Emily
          </a>
        </p>
